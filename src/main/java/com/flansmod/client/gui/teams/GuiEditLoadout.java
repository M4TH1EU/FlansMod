						...
						default: {
							if (stack != null && !stack.isEmpty() && stack.getTagCompound() != null) {
								...
								if (attachmentTags != null) {
									...
									switch (n) {
										case 2:
											attachmentStack = new ItemStack(attachmentTags.getCompoundTag("scope"));
											break;
										case 3:
											attachmentStack = new ItemStack(attachmentTags.getCompoundTag("barrel"));
											break;
										case 4:
											attachmentStack = new ItemStack(attachmentTags.getCompoundTag("stock"));
											break;
										case 5:
											attachmentStack = new ItemStack(attachmentTags.getCompoundTag("grip"));
											break;
										case 6:
											attachmentStack = new ItemStack(attachmentTags.getCompoundTag("generic_0"));
											break;
									}
			...
			default: // Attachments
			{
				if (entry instanceof LoadoutEntryInfoType || entry == null) {
					...
					if (stack != null && !stack.isEmpty()) {
						...
						switch (selectedCategory) {
							case 2:
								attachmentTags.setTag("scope", ourTags);
								break;
							case 3:
								attachmentTags.setTag("barrel", ourTags);
								break;
							case 4:
								attachmentTags.setTag("stock", ourTags);
								break;
							case 5:
								attachmentTags.setTag("grip", ourTags);
								break;
							case 6:
								attachmentTags.setTag("generic_0", ourTags);
								break;
						}
		...
		if (selectedCategory == 1) // Paint
		{
			...
			for (LoadoutEntryInfoType entry : pool.unlocks[selectedSlot.ordinal()]) {
				switch (selectedCategory) {
					...
					case 1:
						break; // Paint. Shouldn't even get here
					default: // Attachments. Check sub-type
					{
						...
						switch (selectedCategory) {
							case 2:
								if (attachType != EnumAttachmentType.sights) continue;
								else break;
							case 3:
								if (attachType != EnumAttachmentType.barrel) continue;
								else break;
							case 4:
								if (attachType != EnumAttachmentType.stock) continue;
								else break;
							case 5:
								if (attachType != EnumAttachmentType.grip) continue;
								else break;
							case 6:
								if (attachType != EnumAttachmentType.generic) continue;
								else break;
						}
						break;
					}
