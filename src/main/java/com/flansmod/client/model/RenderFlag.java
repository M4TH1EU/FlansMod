...
public class RenderFlag extends Render {
	...
	public void doRender(Entity entity, double d, double d1, double d2, float f, float f1) {
		...
		if (team == null) {
			...
			switch (teamID) {
				case 0:
					GL11.glColor3f(0x80 / 255F, 0x80 / 255F, 0x80 / 255F);
					break; //No team
				case 1:
					GL11.glColor3f(0x40 / 255F, 0x40 / 255F, 0x40 / 255F);
					break; //Spectators
				case 2:
					GL11.glColor3f(0xa1 / 255F, 0x7f / 255F, 0xff / 255F);
					break; //Team 1
				case 3:
					GL11.glColor3f(0xff / 255F, 0x7f / 255F, 0xb6 / 255F);
					break; //Team 2
			}
		} else {
