...
public enum EnumMechaToolType {
	...
	public boolean effectiveAgainst(Material material) {
		switch (this) {
			...
			case shovel:
				return material == Material.GRASS || material == Material.GROUND || material == Material.SPONGE || material == Material.SAND || material == Material.SNOW || material == Material.CRAFTED_SNOW || material == Material.CLAY;
			case shears:
