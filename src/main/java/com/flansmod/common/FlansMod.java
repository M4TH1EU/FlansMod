				...
				try {
					...
					switch (type) {
						case bullet:
							...
							break;
						case attachment:
							new ItemAttachment((AttachmentType) infoType).setTranslationKey(infoType.shortName);
							break;
						case gun:
							new ItemGun((GunType) infoType).setTranslationKey(infoType.shortName);
							break;
						case grenade:
							new ItemGrenade((GrenadeType) infoType).setTranslationKey(infoType.shortName);
							break;
						case part:
							partItems.add((ItemPart) new ItemPart((PartType) infoType).setTranslationKey(infoType.shortName));
							break;
						case plane:
							new ItemPlane((PlaneType) infoType).setTranslationKey(infoType.shortName);
							break;
						case vehicle:
							new ItemVehicle((VehicleType) infoType).setTranslationKey(infoType.shortName);
							break;
						case aa:
							new ItemAAGun((AAGunType) infoType).setTranslationKey(infoType.shortName);
							break;
						case mechaItem:
							new ItemMechaAddon((MechaItemType) infoType).setTranslationKey(infoType.shortName);
							break;
						case mecha:
							mechaItems.add((ItemMecha) new ItemMecha((MechaType) infoType).setTranslationKey(infoType.shortName));
							break;
						case tool:
							toolItems.add((ItemTool) new ItemTool((ToolType) infoType).setTranslationKey(infoType.shortName));
							break;
						case box:
							new BlockGunBox((GunBoxType) infoType).setTranslationKey(infoType.shortName);
							break;
						case armour:
							armourItems.add((ItemTeamArmour) new ItemTeamArmour((ArmourType) infoType).setTranslationKey(infoType.shortName));
							break;
						case armourBox:
							new BlockArmourBox((ArmourBoxType) infoType).setTranslationKey(infoType.shortName);
							break;
						case playerClass:
							break;
						case team:
						...
						case itemHolder:
							...
							break;
						case rewardBox:
							new ItemRewardBox((RewardBox) infoType).setTranslationKey(infoType.shortName);
							break;
						case loadout:
							break;
						default:
							log.warn("Unrecognised type for " + infoType.shortName);
							break;
					}
				} catch (Exception e) {
